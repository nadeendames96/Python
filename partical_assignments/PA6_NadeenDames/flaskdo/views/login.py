...
def signup():
    ...
    # when the user submits the form over the HTTP POST
        ...
        user_picture = request.form['user-picture']
        ...
        try:
            ...
            db.execute(
                "INSERT INTO User (firstname,lastname,username,email, password,picture) VALUES (?,?,?,?,?,?);", (firstname,lastname,username,email, password,user_picture))
